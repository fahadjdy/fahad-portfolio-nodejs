<template>
    <div class="flex flex-wrap">
            ...
            <div class="max-w-xlg mx-auto p-6 bg-white shadow-xl rounded-lg ">
                ...
                <form @submit.prevent="addExperience" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" id="designation" v-model="experience.designation" class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm
                    ...
                    <div>
                        ...
                        <input type="text" id="office" v-model="experience.office" class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm
                    focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500
                    transition duration-300" />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="year" v-model="experience.year" class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm
                    focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500
                    transition duration-300" />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description" v-model="experience.description" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm resize-none
                    focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500
        ...
        <ul class="mt-6 divide-y divide-gray-200 ml-10">
            <li v-for="exp in experiences" :key="exp.id" class="py-3 flex justify-between items-center">
                <div>
